...
function Footer() {
  return (
    <footer className="bg-[#1E1E26]">
      <ul className="container mx-auto w-full py-10 flex justify-between text-white">
        ...
        <li className="flex flex-col justify-between text-end">
          <form className="flex gap-2">
            <input
              className="w-[16rem] bg-[#E0E1E6] text-black rounded-full px-5 py-3"
